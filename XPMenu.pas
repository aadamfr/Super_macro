...
begin
  ...
  if Control is TSpeedButton then
    if Control.Visible 
    then if TControl(Control).Parent.Name <> 'Form4' //modif Adam
         then PaintSpeedButton
         else Form4.paintSpeedButton(Control,FMouseInControl); //modif Adam
