...
// PASTLWTR : 1.2
// Fichier généré le 05/09/2006 17:01:05 depuis la bibliothèque de types ci-dessous.
...
// Chaîne d'aide : Microsoft Script Control 1.0
// DepndLst: 
//   (1) v2.0 stdole, (C:\WINDOWS\System32\stdole2.tlb)
// Erreurs :
//   Remarque : le typeinfo Procedure a été changé en Procedure_
//   Remarque : paramètre 'Object' dans IScriptModuleCollection.Add changé en 'Object_'
//   Remarque : paramètre 'Object' dans IScriptControl.AddObject changé en 'Object_'
// ************************************************************************ //
...
// *********************************************************************//
// La classe CoProcedure_ fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IScriptProcedure exposée             
// par la CoClasse Procedure_. Les fonctions sont destinées à être utilisées par            
...
// *********************************************************************//
// La classe CoProcedures fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IScriptProcedureCollection exposée             
// par la CoClasse Procedures. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoProcedures = class
...
// *********************************************************************//
// La classe CoModule fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IScriptModule exposée             
// par la CoClasse Module. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoModule = class
...
// *********************************************************************//
// La classe CoModules fournit une méthode Create et CreateRemote pour          
// créer des instances de l'interface par défaut IScriptModuleCollection exposée             
// par la CoClasse Modules. Les fonctions sont destinées à être utilisées par            
// les clients désirant automatiser les objets CoClasse exposés par       
// le serveur de cette bibliothèque de types.                                            
// *********************************************************************//
  CoModules = class
...
// créer des instances de l'interface par défaut IScriptError exposée             
...
// Nom du contrôle      : TScriptControl
// Chaîne d'aide        : Control to host scripting engines that understand the ActiveX Scripting interface
// Interface par défaut : IScriptControl
// DISP Int. Déf. ?     : No
// Interface événements : DScriptControlSource
